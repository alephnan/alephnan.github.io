...
- GNU FreeSans: the original local reference environment's sans-serif fallback, release 20120503. GPLv3; see `FreeSans-LICENSE.txt`. Corresponding source: https://ftp.gnu.org/gnu/freefont/freefont-src-20120503.tar.gz.
